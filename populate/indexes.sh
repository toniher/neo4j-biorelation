...
# has_go
# TODO: This should be replaced by Fulltext
...
$NEO4JSHELL "CALL db.index.fulltext.createRelationshipIndex(\"go_evidence\",[\"has_go\"],[\"evidence\"] ); " >> $MOMENTDIR/syn.out 2>> $MOMENTDIR/syn.err
$NEO4JSHELL "CALL db.index.fulltext.createRelationshipIndex(\"go_ref\",[\"has_go\"],[\"ref\"] ); " >> $MOMENTDIR/syn.out 2>> $MOMENTDIR/syn.err
$NEO4JSHELL "CALL db.index.fulltext.createRelationshipIndex(\"go_qualifier\",[\"has_go\"],[\"qualifier\"] ); " >> $MOMENTDIR/syn.out 2>> $MOMENTDIR/syn.err
...
$NEO4JSHELL "CALL db.index.fulltext.createRelationshipIndex(\"interact_method\",[\"interacts_with\"],[\"method\"] ); " >> $MOMENTDIR/syn.out 2>> $MOMENTDIR/syn.err
$NEO4JSHELL "CALL db.index.fulltext.createRelationshipIndex(\"interact_type\",[\"interacts_with\"],[\"intype\"] ); " >> $MOMENTDIR/syn.out 2>> $MOMENTDIR/syn.err
$NEO4JSHELL "CALL db.index.fulltext.createRelationshipIndex(\"interact_source\",[\"interacts_with\"],[\"source\"] ); " >> $MOMENTDIR/syn.out 2>> $MOMENTDIR/syn.err
